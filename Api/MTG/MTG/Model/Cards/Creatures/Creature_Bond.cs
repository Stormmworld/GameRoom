    ...
    public class Creature_Bond : Aura
        ...
        */
        public Creature_Bond() :  base(new TargetCardRequirements() { })
        {
            ...
            Add(new TriggeredDamage(EffectTrigger.Card_Destroyed, new TargetRequirements(TargetScope.Single, new List<TargetType>() { TargetType.Player }), new Damage(this, Modifier.Toughness)));
        }
