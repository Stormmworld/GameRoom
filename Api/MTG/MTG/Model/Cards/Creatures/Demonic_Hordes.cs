    ...
    public class Demonic_Hordes : Creature
        ...
        */
        public Demonic_Hordes() : base()
        {
            ...
            Add(new EffectGenerator(true, typeof(DestroyEffect),new TargetRequirements(TargetScope.Single,new List<TargetType>() { TargetType.Card}, new TargetCardRequirements() { HasType= CardType.Land, InZone= TargetZone.Battlefield}), false));
        }
