...
{
    public class Circle_of_Protection_Red : Permanent
        {
        /*
        * http://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=243
        *  
        ...
        *
        */
        public Circle_of_Protection_Red() : base()
        {
            MultiverseId = 243;
            ...
            throw new NotImplementedException("Circle of Protection: Red");
        }
        public Circle_of_Protection_Red(int multiversId) : this()
        {
