    ...
    public class Library_of_Leng : Permanent
        ...
        */
        public Library_of_Leng() : base()
        {
            ...
            TargetRequirements targetRequirements = new TargetRequirements(TargetScope.Controller, TargetType.Player);
            Add(new EffectGeneratorStatic(typeof(NoMaximumHandSizeEffect), targetRequirements) { BoundCardId = Id });
            Add(new MoveToZone(EffectTrigger.Player_Discard, TargetZone.Library, TargetZone.Hand, true) { InsertLocation = InsertLocation.Top });
        }
