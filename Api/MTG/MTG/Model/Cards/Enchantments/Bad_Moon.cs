    ...
    public class Bad_Moon : Permanent
        ...
        */
        public Bad_Moon() : base()
        {
            ...
            Add(new CounterGenerator(EffectTrigger.Card_EntersBattleField,new TargetRequirements(TargetScope.All,  TargetType.Creature, new TargetCardRequirements() {HasColor= Color.Black }), new PlusXPlusY(1,1) ));
        }
