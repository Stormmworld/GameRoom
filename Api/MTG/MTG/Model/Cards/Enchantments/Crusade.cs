    ...
    public class Crusade : Permanent
        ...
        */
        public Crusade() : base()
        {
            ...
            Add(new CounterGenerator(EffectTrigger.Card_EntersBattleField, new TargetRequirements(TargetScope.All,  TargetType.Card, new TargetCardRequirements() { HasColor = Color.White }), new PlusXPlusY(1, 1)));
        }
