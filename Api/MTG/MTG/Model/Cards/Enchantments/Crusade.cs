    ...
    public class Crusade : Permanent
        ...
        */
        public Crusade() : base()
        {
            ...
            Add(new CounterGenerator(EffectTrigger.Card_EntersBattleField, new TargetRequirements(TargetScope.All,  TargetType.Creature , new TargetCardRequirements() { HasColor = Color.White }), new PlusXPlusY(1, 1)));
        }
