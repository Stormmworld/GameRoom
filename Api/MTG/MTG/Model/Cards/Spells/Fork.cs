    ...
    public class Fork : Spell
        ...
        */
        public Fork() : base()
        {
            ...
            Target selfTarget = new Target(TargetType.Card, Id);
            ...
            Add(new CopyCard(abilityCost, selfTarget, targetRequirements1, false) { NewCardColor = Color.Red });
            Add(new CopyCard(abilityCost, selfTarget, targetRequirements2, false) {NewCardColor =  Color.Red });
        }
