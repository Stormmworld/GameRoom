...
{ 
    public class Phasing : ITriggeredAbility
    {
        /*
        ...
        */
        ...
        {
            throw new NotImplementedException("Phasing.GenerateArgs");
        }
        public void Process(ITriggeredAbilityArgs e)
        {
            PhasingTriggeredAbilityArgs args = (PhasingTriggeredAbilityArgs)e;
