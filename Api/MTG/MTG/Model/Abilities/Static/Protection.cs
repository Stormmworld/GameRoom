...
{
    public class Protection: IStaticAbility
    {
        /*
        ...
        public static Protection From(List<Colors> colors)
        {
            return From(colors, new List<CardType>(), new List<SubType>());
        }
        public static Protection From(List<SubType> subTypes)
        {
            return From(new List<Colors>(), new List<CardType>(), subTypes);
        }
        public static Protection From(List<CardType> cardTypes)
        {
            return From(new List<Colors>(), cardTypes, new List<SubType>());
        }
        public static Protection From(List<Colors> colors, List<CardType> cardTypes, List<SubType> subTypes)
        {
